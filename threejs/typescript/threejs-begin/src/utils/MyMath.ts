namespace MyMath {
  ...
  export class Point {
	...
	export function isPointInRect(rect: RectABCD, p: Point): boolean {
  ...
  export function cartesianToIsometric(cartPt: any): Point {
  ...
  export function isometricToCartesian(isoPt: any): Point {
    var tempPt = new Point();
